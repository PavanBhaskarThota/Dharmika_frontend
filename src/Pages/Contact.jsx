...
export const Contact = () => {
	...
	return (
		<Box sx={{ pb: { xs: "4rem", md: "3rem" } }}>
			...
			<Box
				sx={{ m: "auto", width: { xs: "90%", md: "70%" }, mt: "2rem" }}
			>
				<Typography
					sx={{
						textAlign: "center",
				...
				<Typography
					...
					data-aos-duration="900"
				>
					We’re always happy to hear from you. Reach out for queries,
              ...
              <a href="tel:+918332859597" target="_blank" style={{color:'inherit'}}>
                ...
                >
					...
					<Box
						...
						data-aos-duration="900"
					>
						<LocationOnIcon sx={{ color: "#1F3D2B", mt: "2px" }} />
						<Box>
							<Typography sx={{ fontWeight: 500 }}>
								Location
							</Typography>
              <a href="https://maps.app.goo.gl/hXgbJE5uiuJ8Ydhc9" target="_blank" style={{color:'inherit'}}>
							<Typography
								sx={{ color: "#555", fontSize: "0.95rem" }}
                >
